...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  return (
    <div
      className={`sm-scope z-[100] ${isFixed ? 'fixed top-0 left-0 w-screen h-screen pointer-events-none overflow-hidden' : 'relative z-50'}`}
    >
      <div
        className={
      ...
      >
        ...
        >
          {(() => {
            ...
            return arr.map((c, i) => (
              <div
                key={i}
                className="sm-prelayer absolute top-0 right-0 h-[100vh] w-full translate-x-0"
                style={{ background: c }}
              />
            ));
          })()}
        ...
        >
          <div className="sm-logo flex items-center select-none pointer-events-auto" aria-label="Logo">
            {/* The actual component logo would be placed here by the dev, we removed the hardcoded inner logo */}
          </div>
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel absolute top-0 right-0 h-[100vh] bg-white flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px] pointer-events-auto"
      ...
      <style>{`
.sm-scope { position: absolute; z-index: 100; right: 0; pointer-events: none; }
.sm-scope .staggered-menu-wrapper { position: relative; width: 100%; height: 100vh; z-index: 100; pointer-events: none; }
